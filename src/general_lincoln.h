...
#ifndef GENERAL_LINCOLN_H_
#define GENERAL_LINCOLN_H_
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdbool.h>
...
#define MEMORYPOOL_RESERVE_SIZE 0x30D400 //3Mbytes;
...
void write_pgm(char* filename, const unsigned char* src, imsize_u16_lincoln src_size, rect_u16_lincoln* roi);
